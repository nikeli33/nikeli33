...
Работаю на стыке AI и разработки: использую современные инструменты там, где это даёт скорость, и пишу код там, где нужна гибкость. Результат — решения, которые работают и масштабируются.

**Чем занимаюсь:**

- 🤖 Разрабатываю **AI-ассистентов** для продаж, поддержки и администрирования — работают в Telegram, на сайте, внутри сервиса
- ⚡ Строю **Telegram-боты**: продажи, подписки, закрытые сообщества, внутренние задачи
- 🔗 Делаю **интеграции**: CRM, мессенджеры, таблицы, платёжки, уведомления — рутина работает сама
- 🌐 Создаю **веб-приложения** и мини-аппы: сайты, внутренние инструменты, mini Apps
- 🔍 Провожу **аудит и консультации** — нахожу узкие места и составляю план автоматизации
...
| [🔒 Nexus Security Scanner](https://scanner-2.vercel.app) | Проверка безопасности сайтов |
| [🌏 NexusTranslate](https://nexus-translater.lovable.app) | Умный переводчик |
| [🖼️ Image Editor](https://images-redaction.vercel.app) | Редактирование изображений онлайн |
| [📦 Калькулятор доставки](https://china-cargo-buddy.lovable.app) | Калькулятор доставки Китай → Россия |
| [🎵 NPlayer](https://nexus-mplayer.lovable.app) | Nexus Music Player |
| [🎚️ Мастеринг онлайн](https://nexus-mastering.lovable.app) | Профессиональный мастеринг в браузере |
| [✏️ Sketchpad](https://drawing-zen-studio.lovable.app) | Доска для рисования |
...
|---|---|---|
| 🤖 AI-ассистенты | Умные помощники для продаж и поддержки | от 30 000 ₽ |
| 📱 Telegram-боты | Продажи, подписки, закрытые сообщества | от 30 000 ₽ |
| 🔗 Интеграции | CRM, мессенджеры, платёжки, автоматизация | от 15 000 ₽ |
| 🌐 Веб-приложения | Сайты, мини-аппы, внутренние инструменты | от 20 000 ₽ |
| 🔍 Консультация / Аудит | Разбор задачи, план автоматизации | от 2 000 ₽/час |
...
| | |
|---|---|
| 💬 Telegram | [@nikeli33](https://t.me/nikeli33) |
| 💙 VKontakte | [vk.com/id2778777](https://vk.com/id2778777) |
| 📱 WhatsApp | [wa.me/79269084814](https://wa.me/79269084814) |
| 🌐 Сайт | [nexusbots.ru](https://nexusbots.ru) |
| 📧 Email | [nexusbots.studio@gmail.com](mailto:nexusbots.studio@gmail.com) |
| 🗺️ Все контакты | [nikeli33.github.io/contacts](https://nikeli33.github.io/contacts) |
